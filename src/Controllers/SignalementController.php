...
class SignalementController
{
    ...
    public function update(Request $request, Response $response): void
    {
        try {
            ...
            // NOTE: La synchronisation vers Firebase se fait via le bouton "Synchroniser"
            // Pas de sync automatique pour respecter le flux de travail manager
            // $this->firebaseService->updateSignalementInFirebase($signalement);
    ...
    public function updateStatus(Request $request, Response $response): void
    {
        try {
            ...
            // NOTE: Les notifications seront envoyées lors de la synchronisation
            // Pour l'instant, seul PostgreSQL est mis à jour
            /*
